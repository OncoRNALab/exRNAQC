...
my $error_flag			= 0;
my $annotation_path 	= "/user/data/gent/gvo000/gvo00027/TCGA_data/small_RNA_seq/finalscripts/annotation_files/";
...
my $conversion_file = $annotation_path.$organism."/release_UCSC_".$ucsc_version."/Ensembl_".$ensembl_version."_chromosome_names.tsv";
...
my $mirbase_file = $annotation_path.$organism."/release_mirbase_".$mirbase_version."/annotations.gff3";
...
my $ensembl_contaminants_file = $annotation_path.$organism."/release_Ensembl_".$ensembl_version."/biomart_contaminants.txt";
...
my $ucsc_contaminants_file = $annotation_path.$organism."/release_UCSC_".$ucsc_version."/contaminants_tRNA.gtf";
...
my $ucsc_pirna_file = $annotation_path.$organism."/release_UCSC_".$ucsc_version."/contaminants_piRNA.gtf";
