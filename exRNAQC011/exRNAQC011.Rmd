...
spikeconc<-read_tsv("/Users/almorlio/Dropbox (Vandesompele lab)/Basecamp/exRNAQC/ELN general/Spikes/spike_conc.txt")
```
...
miRNAs <- data.table::fread("/Users/almorlio/Dropbox (Vandesompele lab)/Personal/Projects/exRNAQC011_smallRNA/data_raw/miRNAs_extrasubs.txt", header = T, data.table=F) #use the subsampled counts (resulting from subs_miRs.py script - reservoir sampling cf Knuth, 1981)
